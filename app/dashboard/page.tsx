      ...
      {newResponsesCount > 0 && (
        <div className="relative overflow-hidden rounded-3xl border border-[#e8b1bf]/40 bg-gradient-to-r from-paradise-softPink/40 to-white dark:from-white/5 dark:to-[#201F24] p-5 shadow-sm backdrop-blur-md mb-6">
          ...
          <div className="space-y-2.5 max-h-80 overflow-y-auto pr-1">
            {allowedNewResponses.map((r: any) => (
              <Link 
                key={r.id} 
                href={`/service-forms/responses/${r.id}`}
                className="group flex items-center justify-between rounded-2xl border border-black/5 bg-white/70 hover:bg-white dark:bg-white/5 dark:hover:bg-white/10 dark:border-white/10 p-3.5 transition duration-200 shadow-sm"
              >
