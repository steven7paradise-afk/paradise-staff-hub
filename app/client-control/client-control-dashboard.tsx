...
import { BarChart3, Camera, Check, Download, Edit3, Eye, Search, ShoppingBag, Star, Trash2, X, MessageCircle, AlertTriangle, UserX, Layers, User, Mail, Phone, CalendarDays, Receipt, AtSign, Coins, CreditCard, ChevronLeft, ChevronRight, FileText, Save, Loader2, RotateCcw, ShieldCheck, ClipboardCheck, Users, PieChart } from "lucide-react";
...
import { DailyTargetList } from "./daily-target-list";
...
export function ClientControlDashboard({
  ...
  staffProfiles: Array<{ name: string; photoUrl: string | null }>;
  ...
  return (
    <div className="administrative-night-page space-y-6">
            ...
            <div className="mt-5 flex flex-wrap items-center gap-3 border-t border-white/10 pt-4 w-full">
              ...
              <div className="ml-auto flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
                <button
                  ...
                  className="flex min-h-10 items-center justify-center gap-2 rounded-md bg-[#F39BD1] px-4 py-2.5 text-xs font-black text-black shadow-sm transition hover:bg-[#f5add8] disabled:cursor-wait disabled:opacity-60"
                >
      ...
      <DailyTargetList
        responses={monthlyResponses}
        employeeNames={employeeNames}
        corsoStaffNames={corsoStaffNames}
