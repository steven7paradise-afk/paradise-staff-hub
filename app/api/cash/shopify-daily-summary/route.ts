...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json({
    ...
    grossCash: summary.shopifyGrossCash,
    refunds: summary.shopifyCashRefunds,
    netCash: summary.shopifyCash,
    refundCount: summary.cashRefundCount,
    refundRows: summary.cashRefundRows,
    other: 0,
    orders: rows.length,
