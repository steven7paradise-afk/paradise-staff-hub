...
const tools = [
  ...
  },
  {
    ...
    parameters: {
      type: "object",
      properties: {
        document_type: { type: "string", enum: ["CONTRATTO", "PROROGA", "BUSTA_PAGA", "CUD", "LETTERA_CONTESTAZIONE", "DOCUMENTO", "ALL"] },
...
Usa get_document_status per contratti, proroghe/rinnovi, cedolini/buste paga, CUD, lettere di contestazione e documenti HR. “Cedolino” e “busta paga” corrispondono a BUSTA_PAGA; proroga e rinnovo corrispondono a PROROGA; lettere di contestazione e richiami disciplinari corrispondono a LETTERA_CONTESTAZIONE. Usa get_invoice_status per fatture emesse/da fare/annullate e non confondere le fatture con i documenti del personale.
