...
export default async function MyShiftsPage({ searchParams }: { searchParams: Promise<{ month?: string; year?: string; weekOffset?: string; userId?: string }> }) {
  ...
  return (
    <AppShell title="I miei turni" role={sessionUser.role} hideHeader edgeToEdgeMain>
      <div className="my-shifts-liquid relative min-h-screen w-full max-w-none space-y-5 overflow-hidden rounded-none bg-[radial-gradient(circle_at_8%_4%,rgba(255,190,222,0.38),transparent_30%),radial-gradient(circle_at_92%_18%,rgba(218,197,255,0.34),transparent_28%),linear-gradient(145deg,#fff9fc_0%,#f8f5fb_52%,#fff8f2_100%)] p-4 pb-8 pt-20 sm:p-6 sm:pt-24 lg:p-7 lg:pt-24">
