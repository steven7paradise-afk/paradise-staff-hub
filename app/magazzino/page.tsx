...
import { InternalWarehouseManager } from "@/components/internal-warehouse-manager";
...
export default async function MagazzinoPage() {
  ...
  return (
    <AppShell title="Magazzino" subtitle="Scorte interne per salone, magazzino e lettura ordini da Controllo Cliente." role={role}>
      <InternalWarehouseManager initialState={warehouseState} orders={orders} canManage={canManage} />
    </AppShell>
  );
}
