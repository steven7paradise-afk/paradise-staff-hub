...
const allSettings = [
  ...
  { href: "/settings/planning", title: "Planning ON/OFF", text: "Switch admin per attivare o disattivare planning e turni dello staff.", icon: CalendarDays, superAdminOnly: false },
