...
const ROUTE_META: Record<string, RouteMeta> = {
  ...
  "/barcode-labels": { name: "Etichette barcode", description: "Creazione, archivio, selezione e stampa delle etichette Code 128.", group: "Planning & Saloni" },
  ...
  "/client-control/giornata": { name: "Controllo giornata", description: "Verifica giornaliera di foto, note e collaboratrici.", group: "Amministrazione" },
  "/fine-giornata": { name: "Fine giornata", description: "Lettura: storico e commenti. Modifica: compilazione, aggiornamento e nuovi commenti.", group: "Amministrazione" },
