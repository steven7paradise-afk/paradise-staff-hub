...
test("continues the /001 series from existing and locally reserved numbers", () => {
  assert.equal(nextParadiseInvoiceNumber(["3", "82/001"]), "83/001");
  assert.equal(nextParadiseInvoiceNumber(["82/001", "83/001", "NC/12/001"]), "84/001");
});
