  ...
  return (
    <div className="w-full overflow-hidden bg-white">
      ...
      <div className="grid w-full grid-cols-1 overflow-hidden lg:min-h-[calc(100dvh-68px)] lg:grid-cols-[220px_300px_minmax(0,1fr)] xl:h-dvh xl:min-h-0 xl:grid-cols-[76px_220px_300px_minmax(0,1fr)] 2xl:grid-cols-[84px_240px_340px_minmax(0,1fr)]">
        ...
        <section className="flex min-h-[calc(100dvh-210px)] flex-col overflow-hidden border-b border-[#E9E2E5] bg-[#FFFDFE] lg:min-h-0 lg:border-b-0 lg:border-r">
        ...
        <main className={`relative bg-white ${compose || selectedMessage ? "fixed inset-0 z-[90] h-dvh min-h-0 overflow-hidden lg:relative lg:inset-auto lg:z-auto lg:h-auto" : "min-h-[560px] lg:min-h-0"}`}>
          {compose ? (
            ...
            <div className="flex h-full flex-col">
              <div className="sticky top-0 z-20 flex flex-nowrap items-center gap-2 overflow-x-auto border-b border-[#EEE5E9] bg-white px-3 py-3 sm:px-5 sm:py-4">
                <button type="button" onClick={() => setSelectedId(null)} className="mail-action lg:hidden" aria-label="Torna all’elenco"><ArrowLeft className="size-5" /> Indietro</button><span className="mx-1 h-6 w-px shrink-0 bg-black/10 lg:hidden" />
