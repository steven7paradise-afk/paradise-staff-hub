  ...
  return (
    <div className="w-full overflow-hidden bg-white">
      ...
      <div className="grid w-full grid-cols-1 overflow-hidden lg:min-h-[calc(100dvh-68px)] lg:grid-cols-[220px_300px_minmax(0,1fr)] xl:h-dvh xl:min-h-0 xl:grid-cols-[76px_220px_300px_minmax(0,1fr)] 2xl:grid-cols-[84px_240px_340px_minmax(0,1fr)]">
        ...
        <section className="flex h-[calc(100dvh-132px)] min-h-0 flex-col overflow-hidden border-b border-[#E9E2E5] bg-[#FFFDFE] lg:h-auto lg:min-h-0 lg:border-b-0 lg:border-r">
        ...
        <main className={`bg-white ${compose || selectedMessage ? "fixed inset-0 z-[90] h-dvh min-h-0 overflow-hidden lg:relative lg:inset-auto lg:z-auto lg:h-auto" : "relative min-h-[560px] lg:min-h-0"}`}>
          {compose ? (
