        ...
        <div>
          ...
          <div className="mt-6 flex flex-col sm:flex-row items-center gap-5">
            <div className="relative group select-none">
              <div className="relative grid size-20 place-items-center overflow-hidden rounded-full border border-black/10 bg-paradise-nude text-2xl font-extrabold text-paradise-noir shadow-sm dark:border-white/10 dark:bg-neutral-800 dark:text-white">
